...
| --- | --- | --- | --- | --- |
| Socle AI Act UE | 1.3.1 | Règlement européen contraignant | Toutes les voies de l’article 5, tous les cas annexe III, article 6, opérateurs, article 50 et GPAI | [Ouvrir](eu-ai-act/1.3.1/README.fr.md) |
| Socle RGPD IA | 1.3.1 | Règlement européen avec lignes EDPB identifiées | Périmètre, principes, droits, article 22, AIPD, sécurité, transferts et modèles IA | [Ouvrir](eu-gdpr-ai/1.3.1/README.fr.md) |
