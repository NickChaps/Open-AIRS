...
| --- | --- | --- | --- | --- |
| EU AI Act core | 1.3.1 | Binding EU regulation | All Article 5 routes, all Annex III cases, Article 6, operator readiness, Article 50 and GPAI | [Open](eu-ai-act/1.3.1/README.md) |
| EU GDPR AI core | 1.3.1 | Binding EU regulation with marked EDPB guidance | Scope, principles, rights, Article 22, DPIA, security, transfers and AI-model guidance | [Open](eu-gdpr-ai/1.3.1/README.md) |
